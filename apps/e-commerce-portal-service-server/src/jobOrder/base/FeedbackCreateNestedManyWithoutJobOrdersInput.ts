...
@InputType()
class FeedbackCreateNestedManyWithoutJobOrdersInput {
...
export { FeedbackCreateNestedManyWithoutJobOrdersInput as FeedbackCreateNestedManyWithoutJobOrdersInput };
