...
@InputType()
class ProcurementCreateNestedManyWithoutJobOrdersInput {
...
export { ProcurementCreateNestedManyWithoutJobOrdersInput as ProcurementCreateNestedManyWithoutJobOrdersInput };
