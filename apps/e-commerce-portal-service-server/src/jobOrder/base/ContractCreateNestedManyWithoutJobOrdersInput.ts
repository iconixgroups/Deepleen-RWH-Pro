...
@InputType()
class ContractCreateNestedManyWithoutJobOrdersInput {
...
export { ContractCreateNestedManyWithoutJobOrdersInput as ContractCreateNestedManyWithoutJobOrdersInput };
